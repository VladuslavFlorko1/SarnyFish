...
export const registerSchema = {
  [Segments.BODY]: Joi.object({
    username: Joi.string().trim().required().min(3).max(18).pattern(/^[a-zA-Z0-9_]+$/).messages({
      ...
      'string.pattern.base': 'Імʼя користувача може містити лише літери, цифри та підкреслення',
    }),
